...
test("Проверить отображение попапа согласия на использование кук при не установленных куках", async({context}) => {
...
test.fixme("Проверить отображение кнопки “вернуться наверх страницы” при скролле на десктопной версии", async({page}) => {
...
test("Проверить загрузку изображение слайдов", async() => {
...
test("Проверить кнопки переключение слайдов на главной странице", async() => {
...
test("Проверить точки слайдов на главной странице", async() => {
...
test("Проверить переключение табов на главной странице сайта", async({page}) => {
