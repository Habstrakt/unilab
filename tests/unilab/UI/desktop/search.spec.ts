...
test("Проверить работу кнопки 'в корзину' на странице  результата поиска", async({page}) => {
...
test("Проверить загрузку дополнительных результатов поиска на странице поиска", async({page}) => {
