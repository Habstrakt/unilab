...
const newPasswordCases = [
    {
        title: "1. Новый пароль из латиницы",
        newPassword: "unilabpass",
        confirmPassword: "unilabpass",
    },
    {
        title: "2. Новый пароль из кириллицы",
        newPassword: "юнилабпароль",
        confirmPassword: "юнилабпароль",
    },
    {
        title: "3. Новый пароль из латиницы и цифр",
        newPassword: "unilab115007",
        confirmPassword: "unilab115007",
    },
    {
        title: "4. Новый пароль из кириллицы и цифр",
        newPassword: "юнилаб115007",
        confirmPassword: "юнилаб115007",
    },
    {
        title: "5. Новый пароль из латиницы и спецсимволов",
        newPassword: "!unilab@",
        confirmPassword: "!unilab@",
    },
    {
        title: "6. Новый пароль из кириллицы и спецсимволов",
        newPassword: "*юнилаб@",
...
for(const {title, newPassword, confirmPassword} of newPasswordCases) {
    test(`${title} - ${newPassword}`, async ({browser}) => {
        qase.id(4);
        qase.title("MIS-4: Смена пароля пользователя");

        const context = await browser.newContext();
        const page = await context.newPage();

        // вводим логин и пароль от аккаунта
        ...
        await login(page, "test3_ttt", newPassword);
